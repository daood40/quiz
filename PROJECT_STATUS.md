...
| CI | ✅ أخضر: typecheck + 115 اختبارًا (تكامل على PostgreSQL حقيقية) + بناء + `npm audit --audit-level=high` + دخان E2E (Playwright، جوال عربي + سطح مكتب إنجليزي) |
...
- بوابة AI بـ SOURCE_LOCK (`modules/ai`) معطّلة حتى ضبط المفتاح؛ 24 اختبارًا جديدًا (115).
