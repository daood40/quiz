...
const dict = {
  ...
  reminderBody: { en: 'Keep your streak alive — one round takes two minutes.', ar: 'حافظ على سلسلتك — جولة واحدة تأخذ دقيقتين.' },
  reminderDenied: { en: 'Notifications are turned off for this app in system settings.', ar: 'الإشعارات مغلقة لهذا التطبيق في إعدادات النظام.' },
